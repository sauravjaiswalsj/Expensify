...
public class EmailServiceImpl implements EmailService {
    ...
    /****
     * Sends a generic HTML email to the specified recipient with the given subject and body.
     *
     * @param to the recipient's email address
     * @param subject the subject of the email
     * @param body the HTML content of the email
    ...
    /**
     * Sends a verification email containing a one-time code to the specified recipient.
     *
     * The email includes the provided verification code and indicates that it is valid for 15 minutes.
     *
     * @param to the recipient's email address
    ...
    /****
     * Sends a password reset email with a verification code and a 1-hour expiration notice.
     *
     * @param to recipient's email address
     * @param verificationCode the code to include in the email body
     */
    @Override
    ...
    /**
     * Sends an email notification indicating successful account verification to the specified recipient.
     *
     * @param to the recipient's email address
     */
    @Override
    ...
    /**
     * Sends a password reset success notification email to the specified recipient.
     *
     * @param to the recipient's email address
     */
    @Override
    ...
    /**
     * Sends an email with a formatted HTML body using the default template and provided subject and content.
     *
     * The email body is generated by replacing placeholders in the default HTML template with the given subject and content.
     *
     * @param to recipient's email address
     * @param subject subject line of the email
     * @param content main content to be inserted into the email body
     */
