...
//        return Keys.hmacShaKeyFor(keyBytes);
    ...
    /**
     * Generates a JWT token for the specified username using the configured expiration time.
     *
    ...
    /**
     * Validates a JWT by ensuring the username in the token matches the provided user details and the token is not expired.
     *
    ...
    /**
     * Returns the configured expiration time for JWT tokens in milliseconds.
     *
